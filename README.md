...
<table>
  <tr>
    <td width="50%" valign="top">
      <h3>💍 <a href="https://github.com/moinsarwar/rizwan-wdding">Rizwan Wedding</a></h3>
      <p>Digital wedding invitation platform with guest-link RSVPs, wishes wall, admin panel, and QR payment support. PHP API + custom CSS/JS front end.</p>
      <code>PHP</code> · <code>MySQL</code> · <code>JavaScript</code> · <code>Nginx</code>
    </td>
    <td width="50%" valign="top">
  ...
  <tr>
    ...
    <td width="50%" valign="top">
      <h3>🎟️ <a href="https://github.com/moinsarwar/lottery">Lottery System</a></h3>
      <p>Laravel lottery app with auth, dashboard, and draw/management flows for promotional campaigns.</p>
      <code>Laravel</code> · <code>Blade</code> · <code>PHP</code>
    </td>
  </tr>
</table>
<details>
...
* **Workflow automation** — Python orchestration across Gmail, Meta Cloud API, and local LLMs
* **Product features** — embedding Gemini / OpenAI where they cut real operational work
---
### 📈 GitHub Activity
<p align="center">
